...
<head>
  ...
  <title>Mohan Java Project deployment</title>
  <style>
    body {
...
<body>
  ...
  <header>
    <h1>🚀 Mohan Java Project</h1>
    <p>Sample Java app deployment</p>
  </header>
  ...
  <div class="container">
    ...
    <div class="course-card">
      ...
      <div class="course-desc">
        Python, Django, REST APIs, React, and advanced deployment strategies for real-world projects.
      </div>
      <a href="#" class="btn">Enroll Now</a>
    </div>
    ...
    <div class="course-card">
      ...
      <div class="course-desc">
        Machine Learning, Python, Deep Learning, NLP, and real-time data projects.
      </div>
      <a href="#" class="btn">Enroll Now</a>
    </div>
  </div>
